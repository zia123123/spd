...
<div class="col-sm-12">
			...
			<div class="panel panel-default">
					...
					<table class="table" style="" cellspacing="0" >
								...
								<tr>
									...
									<th class="thead center" width="135px">Tiket Pswt Brgkt</th>
									<th class="thead center" width="135px">Tiket Pswt Plg</th>
									<?php } elseif ($moda_angkutan == "kereta api"){ ?>
									<th class="thead center" width="135px">Taxi</th>
									<th class="thead center" width="135px">Tiket KA Brgkt</th>
									<th class="thead center" width="135px">Tiket KA Plg</th>
									<?php } elseif ($moda_angkutan == "travel"){ ?>
									<th class="thead center" width="135px">Taxi</th>
									<th class="thead center" width="135px">Tiket Travel Brgkt</th>
									<th class="thead center" width="135px">Tiket Travel Plg</th>
									...
									<?php } elseif ($jenisbiaya == "darat_hotel" or $jenisbiaya == "darat_non_hotel" or $jenisbiaya == "spi"){ ?>
									<th class="thead center" width="135px">Hotel</th>
									<th class="thead center" width="135px">BBM</th>
									<th class="thead center" width="135px">TOL</th>
									<?php } ?>
							...
							<tbody>
								...
								<tr>
									...
									<?php } elseif ($jenisbiaya == "darat_hotel" or $jenisbiaya == "darat_non_hotel" or $jenisbiaya == "spi"){ ?> 
									<td class="tdskpd"><input type="text" name="uang_hotel[]" data-mask="fdecimal" data-dec="," data-rad="." value="<?php echo $r->uang_hotel;?>" class="form-control"/></td>
									<td class="tdskpd"><input type="text" name="uang_bbm[]" data-mask="fdecimal" data-dec="," data-rad="." value="<?php echo $r->uang_bbm;?>" class="form-control"/></td>
									<td class="tdskpd"><input type="text" name="uang_tol[]" data-mask="fdecimal" data-dec="," data-rad="." value="<?php echo $r->uang_tol;?>" class="form-control"/></td>
									<?php } ?>
								</tr>
								<?php $i++;}?>
							</tbody>
		...
		<div class="col-sm-12">
			...
			<div class="panel panel-default">
					...
					<!--
					<div class="form-group">
						<label class="col-sm-2 control-label">BBM (Rp)</label>
						<div class="input-group col-sm-4">
							<input type="text" id="bbm_rp" name="bbm_rp" class="form-control" />
						</div>
					</div>
					...
					<?php } ?>
					<div class="form-group">
						<label class="col-sm-2 control-label">Keterangan di Rekap Biaya</label>
						<div class="input-group col-sm-4">
							<textarea name="ket_lain" class="form-control" style="min-width:450px; min-height:40px;"><?php echo $data_sppd['ket'];?></textarea>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">Keterangan di SKPD</label>
						<div class="input-group col-sm-4">
							<textarea name="ket_lain_skpd" class="form-control" style="min-width:450px; min-height:40px;"><?php echo $ket_lain_skpd;?></textarea>
						</div>
					</div>
					<div class="form-group">
...
<div class="modal-content" align="center" style="width:95%;">
	...
	<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		...
		<tr>
			...
			<td width="25px">:</td>
			<td width="180px">
				<input type="text" name="total" style="width:150px;" data-mask="decimal" class="form-control" value="" id="total" />
			</td>
			<td class="tdskpd">
