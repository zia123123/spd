		...
		<div class="col-sm-6">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Add Lokasi</h3>
					<div class="panel-options">
					</div>
				</div>
				<div class="panel-body">
					<form action="<?php echo site_url('lokasi/post');?>" role="form" method="post" class="form-horizontal" role="form">
						<div class="form-group">
							<label class="col-sm-3 control-label" for="field-1">Nama Lokasi</label>
							<div class="col-sm-7">
								<input type="text" name="nama_tempat" class="form-control" value="<?php echo set_value('nama_tempat'); ?>" placeholder="Nama Lokasi..." />
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" name="wilayah" class="form-control" value="<?php echo set_value('wilayah'); ?>" placeholder="Wilayah..." />
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" name="titik_koordinat" class="form-control" value="<?php echo set_value('titik_koordinat'); ?>" placeholder="Titik Koordinat..." />
