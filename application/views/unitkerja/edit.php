		...
		<div class="col-sm-6">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form action="<?php echo site_url('unitkerja/edit');?>" role="form" method="post" class="form-horizontal" role="form">
						<div class="form-group">
							<label class="col-sm-3 control-label" for="field-1">Unit Kerja</label>
							<div class="col-sm-7">
								<input type="text" name="unitkerja" class="form-control" value="<?php echo set_value('unitkerja', $r['unitkerja'])?>" placeholder="Unit Kerja..." />
								<?php echo "<input type='hidden' name='id_unitkerja' value='$r[id_unitkerja]'>"; ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<select name="sts" class="form-control" required>
									<option value="1" <?php if($r['sts']=='1'){echo "selected";}?>>PERUM BULOG</option>
									<option value="2" <?php if($r['sts']=='2'){echo "selected";}?>>NON PERUM BULOG</option>
