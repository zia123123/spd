...
<div>
	<img src="xenon/images/kop_skpd.png" style="left:0px;width:2400px;"/>
	<br/>
	<!--
	...
	<tr>
		...
		<td colspan="3" width="460px" height="50px">
	...
	<tr>
		...
		<td colspan="6" style="border:none;height:20px;"><b>Ketua Pelaksana Tugas :</b></td>
	</tr>
	<tr>
		<th width="30px">No</th>
		<th width="140px">Nama</th>
		<th width="55px">No Reg</th>
	...
	<tr>
		...
		<td align="center">Pemimpin</td>
		<?php } elseif ($row->jabatan == "Wakil Pemimpin") { ?>
		<td align="center">Wakil Pemimpin</td>
		<?php } else { ?>
	...
	<tr>
		<td colspan="6" style="border:none;height:20px;"><b>Pelaksana Tugas :</b></td>
	</tr>
	<tr>
		<th>No</th>
		<th>Nama</th>
	...
	<tr>
		<td width="160px">- Durasi Tugas</td>
		<td width="15px">:</td>
	...
	<tr>
		...
		?>
		<td>:</td>
		<td><?php echo $tgl_brgkt_indo; ?></td>
	</tr>
	<tr>
		<td>- Tempat Tujuan</td>
		<td>:</td>
		<td align="justify"><?php echo $row->tmpt_tujuan; ?></td>
	</tr>
	<tr>
		...
		?>
		<td>:</td>
		<td><?php echo $tgl_pulang_indo; ?></td>
	</tr>
	<tr>
	...
	<tr>
		<td width="70px"></td>
		<td width="310px">Bandung, <?php echo $tgl_sppd_indo; ?></td>
		<td></td>
	</tr>
	<tr>
	...
	<tr>
		<td width="70px"></td>
		<td style="color:#e36c0a;">Bersama Mewujudkan Kedaulatan Pangan </td>
	</tr>
	</table>	
<?php
	}
