		...
		<div class="col-sm-10">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form action="<?php echo site_url('notaintern/post');?>" role="form" method="post" class="form-horizontal" role="form">
						<div class="form-group">
							<label class="col-sm-3 control-label" for="field-1">Nomor/Tgl Nota Intern</label>
							<div class="col-sm-1">
								<input type="text" name="no_ni" class="form-control" value="<?php echo $no_ni; ?>" />
							</div>
							<div class="col-sm-3">
								<input type="text" name="kode_ni" class="form-control" value="<?php echo '/10040/RT/'.$bulan_ini."/".$tahun_ini; ?>" />
							</div>
							<div class="col-sm-4">
								<input type="text" name="tgl_ni" class="form-control datepicker" value="<?php echo $hari_ini; ?>" data-format="dd-mm-yyyy">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<?php echo buatcombo('kepada_nama', 'tb_pegawai', '', 'nama_pegawai', 'nama_pegawai','' , array('id'=>'kepada_nama','class'=>'form-control', 'data-placeholder'=>'Pilih Pejabat'))?>
	
							</div>
							<div class="col-sm-4">
								<input type="text" name="kepada_jab" id="kepada_jab" class="form-control"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<?php echo buatcombo2('dari_nama', 'tb_pegawai', '', 'nama_pegawai', 'nama_pegawai', '' , array('id'=>'dari_nama','class'=>'form-control', 'data-placeholder'=>'Pilih Pejabat'))?>
							</div>
							<div class="col-sm-4">
								<input type="text" name="dari_jab" id="dari_jab" class="form-control"/>
							</div>
								<script type="text/javascript">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input name="perihal" type="text" required placeholder="Perihal.." value="<?php echo set_value('perihal'); ?>" class="form-control"/>								
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<?php echo textarea('dasar_ni', 'dasar_ni', 'col-sm-02', 2, set_value('dasar_ni',''),'');?>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<?php echo textarea('isi_ni', 'isi_ni', 'col-sm-02', 3, set_value('isi_ni','Bersama ini kami mengajukan ............ bulan '.$blnthn_ini),'');?>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" required name="nominal" data-mask="fdecimal" data-dec="," data-rad="." value="" class="form-control"/>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<?php echo textarea('closing', '', '', 2, set_value('closing','Demikian kami sampaikan, mohon persetujuan lebih lanjut.'), '');?>
							</div>
						</div>
						<div class="form-group-separator"></div>
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="jenis_ni" class="form-control">
									...
									<option value="Pertaja">Pertaja</option>
								</select>
							</div>
						</div>
						<div class="form-group-separator"></div>
