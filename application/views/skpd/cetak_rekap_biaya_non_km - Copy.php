...
<div style="width:100%;">
	...
	<tr>
		...
		<?php } else { ?>
			...
			<th width="35px">GOL</th>
			<th width="75px">UANG HARIAN</th>
					
			<th width="55px">UANG REPRES.</th>
			<th width="70px">JUMLAH</th>
			<th width="85px" colspan="2">PPH (Rp)</th>	
			<th width="55px">UANG BBM</th>
			<th width="70px">TOTAL</th>			
			<th width="90px">DITERIMA PER ORANG</th>
	...
	<tr>
		...
		<?php } else { ?>
			...
			<td class="row_small">5</td>
			<td class="row_small">6</td>
			<td class="row_small" width="30px">7</td>
			<td class="row_small" width="55px">8 = 6x7</td>
			<?php if($angkutan == "kendaraan dinas"){ ?>
			<td class="row_small">9</td>
			<td class="row_small">10 = 6+9</td>
			<td class="row_small">11 = 6-8+9</td>
			<td class="row_small">11</td>
			<?php } else { ?>
	...
	<?php } else { ?>
			...
			<tr>
				<td width="10px"><b>1.</b></td>
				<td colspan="2" width="525px"><b>KOLOM 4 :</b></td>
...
<div style="width:100%;">
	...
	<tr>
		<td colspan="3" width="305px" class="fbc10" style="line-height:25px;">VERIFIKASI TEKNIS/SEKSI SES &#38; HUM</td>
	...
	<tr>
		<td colspan="2" class="fbc12" style="line-height:20px;">SEKRETARIAT &#38; HUMAS</td>
