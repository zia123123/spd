...
<div style="width:100%;">
	...
	<tr>
		...
		<?php } elseif($jenisbiaya == "darat_hotel" or $jenisbiaya == "spi"){ ?>		
			...
			<?php } else { ?>
			<th width="65px">TIKET</th>
			<?php } ?>
			<th width="55px">UANG REPRES.</th>
			<th width="70px">JUMLAH</th>
			<th width="90px" colspan="2">PPH (Rp)</th>
			<?php if($angkutan == "kendaraan dinas"){ ?>
			<th width="205px">DITERIMA PER ORANG</th>
			<?php } else { ?>
			<th width="60px">TIKET</th>
		...
		<?php } else { ?>
			...
			<?php if($angkutan == "kendaraan dinas"){ ?>
			<th width="75px">UANG BBM</th>
			<?php } else { ?>
			<th width="75px">TIKET</th>
			<?php } ?>
			<th width="55px">UANG REPRES.</th>
			<th width="70px">JUMLAH</th>
			<th width="90px" colspan="2">PPH (Rp)</th>
			<?php if($angkutan == "kendaraan dinas"){ ?>
			<th width="250px">DITERIMA PER ORANG</th>
			<?php } else { ?>
			<th width="60px">TIKET</th>
			<th width="70px">TOTAL</th>
			<th width="120px">DITERIMA PER ORANG</th>
			<?php } ?>
			<th width="75px">YANG MENERIMA</th>
		<?php } ?>
	</tr>
	<tr>
		...
		<?php } elseif($jenisbiaya == "pswt_krywn_non_hotel" or $jenisbiaya == "pswt_ka_waka_non_hotel"){ ?>
			...
			<td class="row_small" width="60px">10 = 8x9</td>
		...
		<?php } else { ?>
			...
			<td class="row_small" width="60px">9 = 7x8</td>
			<?php if($angkutan == "kendaraan dinas"){ ?>
	...
	<?php if($jenisbiaya == "pswt_krywn_hotel" or $jenisbiaya == "pswt_ka_waka_hotel"){ ?>
		<tr>
			<td width="10px"><b>1.</b></td><td colspan="2" width="600px"><b>KOLOM 7 :</b></td>
	...
	<?php } elseif($jenisbiaya == "pswt_krywn_non_hotel" or $jenisbiaya == "pswt_ka_waka_non_hotel"){ ?>
		<tr>
			<td width="10px"><b>1.</b></td><td colspan="2" width="600px"><b>KOLOM 6 :</b></td>
			<td rowspan="12" width="205px" align="center">
				SEMARANG, <?php echo $tgl_skpd_indo; ?> <br/><br/><br/><br/>
				<b><?php echo strtoupper($pemeriksa_3); ?></b><br/>
				<?php echo strtoupper($jabatan_3); ?>
	...
	<?php } elseif($jenisbiaya == "darat_hotel" or $jenisbiaya == "spi"){ ?>
			...
			<tr>
				...
				<td colspan="2" width="500px"><b>KOLOM 6 :</b></td>
