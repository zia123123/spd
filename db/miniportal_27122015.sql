...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 27, 2015 at 03:48 PM
...
(1, '780000984', '6183595', 'Usep Karyana', 'Usep Karyana', '16', 'KEPALA DIVRE JATENG', 'Kepala Divre Jateng', 'Divre Jateng', '5/1/2017', '1/2/2013', '7/8/2015', 'S1 - EKONOMI AKUNTANSI', 1, 1, 30, '5/14/1961'),
(2, '780007119', '7297194', 'SOPRAN KENEDI , SP , M.Sc', 'Sopran Kenedi', '13', 'WAKIL KEPALA DIVISI REGIONAL JATENG PERUM BULOG', 'Wakil Kepala Divre Jateng', 'Divre Jateng', '6/30/2028', '12/1/2015', '12/1/2015', 'S2 - MANAJEMEN AGRIBISNIS', 1, 1, 25, '6/21/1972'),
...
(234, 'Sopran Kenedi', 'Wakil Kepala Divre Jateng', 'Widoyo Seno', 'Kasi TU & Umum', '2', NULL, 'semarang', '27-12-2015', 'Perum Bulog Kantor Pusat Jakarta', '31-12-2015', 'Pelaksanaan Supervisi Pemuatan Beras Impor Luar Negeri', '', 1, '23-12-2015 02:21:03pm', 'Berdasarkan Faksimili Kantor Pusat Perum BULOG Nomor : F-2878/DO200/23122015 Tanggal 23 Desember 2015. Bersama ini mohon agar kepada nama/nama-nama berikut ini diterbitkan SKPD untuk melaksanakan Perjalanan Dinas dengan rincian sebagai berikut :', 'F-2878/DO200/23122015', '23-12-2015');
...
(1, 'admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', 1, '', '2015-12-27 19:27:24');
...
--
ALTER TABLE `tb_pegawai`
  MODIFY `id_pegawai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=434;
--
...
--
ALTER TABLE `tb_pelaksana`
  MODIFY `id_pelaksana` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=583;
--
...
--
ALTER TABLE `tb_skpd`
  MODIFY `id_skpd` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=122;
--
-- AUTO_INCREMENT for table `tb_sppd`
--
ALTER TABLE `tb_sppd`
  MODIFY `id_sppd` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=235;
--
