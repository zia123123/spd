...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2015 at 01:12 PM
...
(6, 'Sarmijan', 'Pengemudi', 'Divre Jateng', '1', 6),
...
(1, 'admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', 1, '', '2015-12-07 19:09:46'),
...
--
ALTER TABLE `tb_lokasi`
  MODIFY `id_lokasi` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;
--
...
--
ALTER TABLE `tb_pelaksana`
  MODIFY `id_pelaksana` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=261;
--
-- AUTO_INCREMENT for table `tb_pengemudi`
--
ALTER TABLE `tb_pengemudi`
  MODIFY `id_pengemudi` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `tb_sppd`
  MODIFY `id_sppd` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=144;
--
