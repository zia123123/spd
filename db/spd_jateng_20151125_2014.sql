...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2015 at 02:14 PM
...
INSERT INTO `tb_golongan` (`id_gol`, `gol`, `nama_gol`, `klasifikasi`, `raskin`, `management_reg`, `management_diklat`) VALUES
(1, 'I', 'Penata', 'D', 0, 0, 0),
(2, 'II', 'Penata ', 'D', 0, 0, 0),
(3, 'III', 'Penata', 'D', 0, 0, 0),
(4, 'IV', 'Penata', 'D', 0, 0, 0),
(5, 'V', 'Penata', 'C', 350000, 315000, 350000),
(6, 'VI', 'Penata', 'C', 350000, 315000, 350000),
(7, 'VII', 'Penata', 'C', 350000, 315000, 350000),
(8, 'VIII', 'Penata', 'C', 350000, 315000, 350000),
(9, 'IX', 'Penata', 'B', 400000, 360000, 400000),
(10, 'X', 'Penata', 'B', 400000, 360000, 400000),
(11, 'XI', 'Penata', 'B', 400000, 360000, 400000),
(12, 'XII', 'Penata', 'B', 400000, 360000, 400000),
(13, 'XIII', 'Penata', 'A', 450000, 405000, 450000),
(14, 'XIV', 'Penata', 'A', 450000, 405000, 450000),
(15, 'XV', 'Penata', 'A', 450000, 405000, 450000),
(16, 'XVI', 'Penata', 'A', 450000, 405000, 450000),
(17, 'XVII', 'Penata', 'A', 450000, 405000, 450000);
...
INSERT INTO `tb_pelaksana` (`id_pelaksana`, `noreg`, `status_pelaksana`, `id_sppd`, `uang_harian`, `uang_repres`, `jumlah`, `pph`, `potongan`, `jumlah_diterima`) VALUES
(119, '9112356', 1, 106, '1050000.00', NULL, '1050000.00', 15, '157500.00', '892500.00'),
(120, '8108629', 0, 106, '1050000.00', NULL, '1050000.00', 15, '157500.00', '892500.00'),
(121, '7397305', 1, 107, '800000.00', NULL, '800000.00', 15, '120000.00', '680000.00'),
(122, '9112356', 0, 107, '700000.00', NULL, '700000.00', 15, '105000.00', '595000.00'),
(123, '6908761', 0, 107, '700000.00', NULL, '700000.00', 15, '105000.00', '595000.00'),
(124, '8108629', 0, 107, '700000.00', NULL, '700000.00', 15, '105000.00', '595000.00');
...
CREATE TABLE `tb_skpd` (
  ...
  `jenis_skpd` varchar(255) DEFAULT NULL,
...
INSERT INTO `tb_skpd` (`id_skpd`, `no_skpd`, `tgl_skpd`, `attr_skpd`, `jenis_skpd`, `angkutan`, `dasar`, `perlengkapan`, `ket_lain`, `jarak`, `hasil_km`, `jenis_bbm`, `harga_bbm`, `harian_bbm`, `jml_bbm`, `id_sppd`) VALUES
(13, 2, '25-11-2015', ' / 11030 / 11 / 2015', 'raskin', 'kendaraan dinas', 'Bersama ini mohon agar kepada nama/nama-nama berikut ini diperintahkan melaksanakan Perjalanan Dinas dengan rincian sebagai berikut :', 'Membawa Perlengkapan Seperlunya', '               ', 201, '40.20', 'premium', 7400, '30.00', '519480.00', '106'),
(14, 3, '25-11-2015', ' / 11030 / 11 / 2015', 'raskin', 'kendaraan dinas', 'Bersama ini mohon agar kepada nama/nama-nama berikut ini diperintahkan melaksanakan Perjalanan Dinas dengan rincian sebagai berikut :', 'Membawa Perlengkapan Seperlunya', '               ', 537, '107.40', 'premium', 7400, '20.00', '942760.00', '107');
...
(106, 'Arwakhudin Widiarso', 'Wakil Kepala', 'Rudi Amran', 'Kabid Minku', '3', 'semarang', '04-12-2015', 'GBB SELANG', '06-12-2015', 'Monitoring RR', '', 1, '25-11-2015 06:31:17pm', 'Bersama ini mohon agar kepada nama/nama-nama berikut ini diperintahkan melaksanakan Perjalanan Dinas dengan rincian sebagai berikut :'),
(107, 'Arwakhudin Widiarso', 'Wakil Kepala', 'Rudi Amran', 'Kabid Minku', '2', 'semarang', '02-12-2015', 'GBB KLAHANG,GBB MULYADADI', '03-12-2015', 'Jalan jalan', '', 1, '25-11-2015 08:03:46pm', 'Bersama ini mohon agar kepada nama/nama-nama berikut ini diperintahkan melaksanakan Perjalanan Dinas dengan rincian sebagai berikut :');
...
(1, 'admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', 1, '', '2015-11-25 16:49:40'),
...
--
ALTER TABLE `tb_lokasi`
  MODIFY `id_lokasi` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
...
--
ALTER TABLE `tb_pejabat_ttd`
  MODIFY `id_pejabat_ttd` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tb_pelaksana`
--
ALTER TABLE `tb_pelaksana`
  MODIFY `id_pelaksana` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
--
...
--
ALTER TABLE `tb_skpd`
  MODIFY `id_skpd` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `tb_sppd`
--
ALTER TABLE `tb_sppd`
  MODIFY `id_sppd` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
--
-- AUTO_INCREMENT for table `tb_tempat`
--
ALTER TABLE `tb_tempat`
  MODIFY `id_tempat` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
--
