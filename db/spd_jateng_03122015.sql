...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 03, 2015 at 12:49 PM
...
(1, 'I', 'Penata', 'D', 0, 0, 0, NULL, NULL, NULL),
(2, 'II', 'Penata ', 'D', 0, 0, 0, NULL, NULL, NULL),
(3, 'III', 'Penata', 'D', 0, 0, 0, NULL, NULL, NULL),
(4, 'IV', 'Penata', 'D', 0, 0, 0, NULL, NULL, NULL),
(5, 'V', 'Penata', 'C', 350000, 315000, 350000, 200000, 350000, 200000),
(6, 'VI', 'Penata', 'C', 350000, 315000, 350000, 200000, 350000, 200000),
(7, 'VII', 'Penata', 'C', 350000, 315000, 350000, 200000, 350000, 200000),
(8, 'VIII', 'Penata', 'C', 350000, 315000, 350000, 200000, 350000, 200000),
(9, 'IX', 'Penata', 'B', 400000, 360000, 400000, 200000, 450000, 200000),
(10, 'X', 'Penata', 'B', 400000, 360000, 400000, 200000, 450000, 200000),
(11, 'XI', 'Penata', 'B', 400000, 360000, 400000, 200000, 450000, 200000),
(12, 'XII', 'Penata', 'B', 400000, 360000, 400000, 200000, 450000, 200000),
(13, 'XIII', 'Penata', 'A', 450000, 405000, 450000, 200000, 550000, 200000),
(14, 'XIV', 'Penata', 'A', 450000, 405000, 450000, 200000, 550000, 200000),
(16, 'XVI', 'Penata', 'A', 450000, 405000, 450000, 200000, 550000, 200000),
(17, 'XVII', 'Penata', 'A', 450000, 405000, 450000, 200000, 550000, 200000);
...
(67, '780001234', '1122334', 'VT. Rapi Indirastuti', 'XII', 'Kasi Penyaluran', 'Divre Jateng', 1, 1, 15),
(68, '081144774', '1144774', 'Joko Pamungkas', 'XII', 'Kasi SDM & Hukum', 'Divre Jateng', 1, 0, 15);
...
(1, 'admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', 1, '', '2015-12-03 16:33:17'),
...
--
ALTER TABLE `tb_lokasi`
  MODIFY `id_lokasi` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
--
...
--
ALTER TABLE `tb_pelaksana`
  MODIFY `id_pelaksana` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=197;
--
...
--
ALTER TABLE `tb_skpd`
  MODIFY `id_skpd` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
--
-- AUTO_INCREMENT for table `tb_sppd`
--
ALTER TABLE `tb_sppd`
  MODIFY `id_sppd` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=130;
--
