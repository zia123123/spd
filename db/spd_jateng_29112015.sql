...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2015 at 01:11 PM
...
INSERT INTO `tb_pelaksana` (`id_pelaksana`, `noreg`, `status_pelaksana`, `id_sppd`, `uang_harian`, `uang_repres`, `uang_hotel`, `uang_taxi`, `uang_pesawat_b`, `uang_pesawat_p`, `uang_kereta_b`, `uang_kereta_p`, `uang_travel_b`, `uang_travel_p`, `jumlah`, `pph`, `potongan`, `jumlah_diterima`) VALUES
(131, '7453621', 1, 111, '800000.00', NULL, '450000.00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1250000.00', 15, '187500.00', '1062500.00'),
(132, '4445551', 0, 111, '900000.00', NULL, '550000.00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1450000.00', 15, '217500.00', '1232500.00'),
(133, '8881235', 0, 111, '700000.00', NULL, '350000.00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1050000.00', 15, '157500.00', '892500.00');
...
(17, 1, '29-11-2015', ' / 11030 / 11 / 2015', 'darat_hotel', 'kendaraan dinas', 'Bersama ini mohon agar kepada nama/nama-nama berikut ini diperintahkan melaksanakan Perjalanan Dinas dengan rincian sebagai berikut :', 'Membawa Perlengkapan Seperlunya', '               ', 224, '44.80', 'premium', 7400, '20.00', '479520.00', '111');
...
(1, 'admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', 1, '', '2015-11-29 18:33:25'),
...
--
ALTER TABLE `tb_lokasi`
  MODIFY `id_lokasi` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
--
...
--
ALTER TABLE `tb_pejabat_ttd`
  MODIFY `id_pejabat_ttd` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tb_pelaksana`
--
ALTER TABLE `tb_pelaksana`
  MODIFY `id_pelaksana` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=134;
--
...
--
ALTER TABLE `tb_skpd`
  MODIFY `id_skpd` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT for table `tb_sppd`
--
ALTER TABLE `tb_sppd`
  MODIFY `id_sppd` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;
--
