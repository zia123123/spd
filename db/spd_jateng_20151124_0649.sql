...
INSERT INTO `tb_skpd` (`id_skpd`, `no_skpd`, `tgl_skpd`, `attr_skpd`, `jenis_skpd`, `id_sppd`) VALUES
(1, 1, '18-11-2015', ' / 11030 / 11 / 2015', '2', '104');
...
(102, 'Usep Karyana', 'Kepala', 'Rudi Amran', 'Kabid Minkeu', '4', 'semarang', '16-11-2015', 'GBB Ngabean,GBB Banaran', '19-11-2015', 'Monitoring ISO', 'a', 0, '16-11-2015 03:39:00pm'),
...
(104, 'Usep Karyana', 'Kepala', 'Arwakhudin Widiarso', 'Wakil Kepala', '2', 'semarang', '27-11-2015', 'GBB Banaran', '28-11-2015', 'Melayani Tamu', '', 1, '16-11-2015 05:35:58pm');
...
INSERT INTO `tb_tempat` (`id_tempat`, `nama_tempat`, `wilayah`, `latlng`) VALUES
(2, 'Subdivre Semarang', 'Subdivre Semarang', '-6.903250713826217,109.65866088867188'),
(3, 'GBB Bawen', 'Subdivre Semarang', '-7.611636313903957,110.80535888671875'),
(4, 'GBB Ngabean', 'Subdivre Surakarta', '-7.3651907945112365,109.89898681640625'),
(5, 'GBB Meger', 'Subdivre Surakarta', '-7.691939004864697,110.643310546875'),
(6, 'GBB Kaliwungu', 'Subdivre Semarang', '-7.810323674279223,110.93994140625'),
(7, 'GBB Lohmanis', 'Subdivre Banyumas', '-6.9935097814125085,110.41833758354187'),
(8, 'GBB Banaran', 'Subdivre Surakarta', '-7.6507687512437625,110.67798614501953'),
(9, 'GBB Palebon', 'Subdivre Semarang', '-7.00898254080151,110.46671390533447');
...
(1, 'admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', 1, '', '2015-11-24 06:33:40'),
...
--
ALTER TABLE `tb_skpd`
  MODIFY `id_skpd` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tb_tempat`
  MODIFY `id_tempat` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
