...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2015 at 11:28 AM
...
(16, 'XVI', 'Penata', 'IV', 450000, 405000, 450000, 200000, 550000, 200000),
(17, 'XVII', 'Penata', 'IV', 450000, 405000, 450000, 200000, 550000, 200000);
...
(82, 'semarang', 'GBB KEDUNGREJO', 136);
...
(209, '7408484', 'Kartini', 'VI', 'Staf Minku', 'Divre Jateng', 1, 136, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(210, '8206089', 'Anastasia Ratna Khrism', 'XI', 'Staf Minku', 'Divre Jateng', 0, 136, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(211, '6095242', 'S U Y A N T O', 'X', 'Staf Minku', 'Divre Jateng', 0, 136, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(136, 'Sopran Kenedi', 'Wakil Kepala', 'Sri Muniati', 'RM UB Bulogmart', '2', 'semarang', '07-12-2015', 'GBB KEDUNGREJO', '08-12-2015', 'Melayani Tamu', '', 0, '04-12-2015 02:26:41pm', 'Bersama ini mohon agar kepada nama/nama-nama berikut ini diperintahkan melaksanakan Perjalanan Dinas dengan rincian sebagai berikut :');
...
INSERT INTO `tb_unitkerja` (`id_unitkerja`, `unitkerja`, `alamat`) VALUES
(1, 'Divre Jateng', 'Jl. Menteri Supeno I/1 A, Semarang'),
(2, 'Subdivre Semarang', 'Semarang'),
(3, 'Subdivre Pati', 'Pati'),
(4, 'Subdivre Surakarta', 'Surakarta'),
(5, 'Subdivre Banyumas', 'Banyumas'),
(6, 'Subdivre Kedu', 'Kedu'),
(7, 'Subdivre Pekalongan', 'Pekalongan');
...
(1, 'admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', 1, '', '2015-12-04 15:29:56'),
(14, 'keuangan', '', 'a4151d4b2856ec63368a7c784b1f0a6e', 2, '', '2015-12-04 15:28:19'),
...
--
ALTER TABLE `tb_golongan`
  MODIFY `id_gol` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT for table `tb_lokasi`
--
ALTER TABLE `tb_lokasi`
  MODIFY `id_lokasi` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
--
-- AUTO_INCREMENT for table `tb_pegawai`
--
ALTER TABLE `tb_pegawai`
  MODIFY `id_pegawai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
--
...
--
ALTER TABLE `tb_pelaksana`
  MODIFY `id_pelaksana` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=212;
--
-- AUTO_INCREMENT for table `tb_pengemudi`
--
ALTER TABLE `tb_pengemudi`
  MODIFY `id_pengemudi` int(255) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tb_pengikut`
--
ALTER TABLE `tb_pengikut`
  MODIFY `id_pengikut` int(255) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tb_skpd`
  MODIFY `id_skpd` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
--
-- AUTO_INCREMENT for table `tb_sppd`
--
ALTER TABLE `tb_sppd`
  MODIFY `id_sppd` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;
--
...
--
ALTER TABLE `tb_unitkerja`
  MODIFY `id_unitkerja` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
