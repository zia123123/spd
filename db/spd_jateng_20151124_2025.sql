...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 24, 2015 at 02:25 PM
...
INSERT INTO `tb_golongan` (`id_gol`, `gol`, `nama_gol`, `klasifikasi`) VALUES
(1, 'I', 'Penata Tingkat I', 'E'),
(2, 'II', 'Penata ', 'D'),
(3, 'III', 'Penata', 'D'),
(4, 'IV', 'Penata', 'D'),
(5, 'V', 'Penata', 'D'),
...
(18, 'semarang', 'GBB Ngabean', 102),
(19, 'semarang', 'GBB Banaran', 102),
(24, 'semarang', 'GBB Banaran', 104),
(25, 'semarang', 'GBB Meger', 103),
(26, 'semarang', 'GBB Palebon', 103);
...
INSERT INTO `tb_pegawai` (`id_pegawai`, `nip`, `noreg`, `nama_pegawai`, `golongan`, `jabatan`, `unitkerja`, `sts`, `sts_pejabat`) VALUES
(57, '780000984', '6183595', 'Usep Karyana', 'XVI', 'Kepala', 'Divre Jateng', 1, 1),
(58, '780007254', '7197261', 'Arwakhudin Widiarso', 'XIII', 'Wakil Kepala', 'Divre Jateng', 1, 1),
(59, '780007094', '6797095', 'Rudi Amran', 'XIV', 'Kabid Minkeu', 'Divre Jateng', 1, 1),
(60, '780007030', '7397305', 'Widoyo Seno', 'X', 'Kasi TU & Umum', 'Divre Jateng', 1, 1),
(61, '129112356', '9112356', 'M. Maulana. R', 'VII', 'Staf TU & Umum', 'Divre Jateng', 1, 0),
(62, '086908761', '6908761', 'Giri Nugroho', 'VI', 'Staf TU & Umum', 'Divre Jateng', 1, 0),
(63, '088108629', '8108629', 'Indarto Muji', 'VI', 'Staf TU & Umum', 'Divre Jateng', 1, 0);
...
INSERT INTO `tb_pelaksana` (`id_pelaksana`, `noreg`, `status_pelaksana`, `id_sppd`) VALUES
(100, '9112356', 1, 102),
(101, '7397305', 0, 102),
(102, '6908761', 0, 102),
(108, '6797095', 1, 104),
...
(11, 1, '24-11-2015', ' / 11030 / 11 / 2015', 'manajemen_reg', 'kendaraan dinas', 'Bersama ini mohon agar kepada nama/nama-nama berikut ini diperintahkan melaksanakan Perjalanan Dinas dengan rincian sebagai berikut :', 'Membawa Perlengkapan Seperlunya', 'a    ', 213, '42.60', 'premium', 7400, '40.00', '611240.00', '102');
...
INSERT INTO `tb_sppd` (`id_sppd`, `pemberi_tgs`, `jab_pemberi_tgs`, `pemohon_tgs`, `jab_pemohon_tgs`, `durasi_tgs`, `tmpt_keberangkatan`, `tgl_keberangkatan`, `tmpt_tujuan`, `tgl_kepulangan`, `tugas`, `ket`, `sts`, `tgl_sppd`) VALUES
(102, 'Usep Karyana', 'Kepala', 'Rudi Amran', 'Kabid Minkeu', '4', 'semarang', '16-11-2015', 'GBB Ngabean,GBB Banaran', '19-11-2015', 'Monitoring ISO', 'a', 1, '16-11-2015 03:39:00pm'),
(103, 'Arwakhudin Widiarso', 'Wakil Kepala', 'Rudi Amran', 'Kabid Minkeu', '5', 'semarang', '16-11-2015', 'GBB Meger,GBB Palebon', '20-11-2015', 'Monitoring ISO', '', 0, '16-11-2015 03:46:38pm'),
(104, 'Usep Karyana', 'Kepala', 'Arwakhudin Widiarso', 'Wakil Kepala', '2', 'semarang', '27-11-2015', 'GBB Banaran', '28-11-2015', 'Melayani Tamu', '', 0, '16-11-2015 05:35:58pm');
...
(1, 'admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', 1, '', '2015-11-24 18:20:44'),
...
--
ALTER TABLE `tb_lokasi`
  MODIFY `id_lokasi` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
--
...
--
ALTER TABLE `tb_pelaksana`
  MODIFY `id_pelaksana` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
--
...
--
ALTER TABLE `tb_skpd`
  MODIFY `id_skpd` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `tb_sppd`
--
ALTER TABLE `tb_sppd`
  MODIFY `id_sppd` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;
--
